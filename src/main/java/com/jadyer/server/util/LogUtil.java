...
public final class LogUtil {
	...
	private static Log orderResultNotifyLogger = LogFactory.getLog("orderResultNotifyLogger");
	private static Log netBankResultNotifyLogger = LogFactory.getLog("netBankResultNotifyLogger");
...
//	}
	 ...
	 * 获取订单结果通知日志记录器
	 */
	public static Log getOrderResultNotifyLogger() {
		Log log = currentLoggerMap.get();
		if(null == log){
			currentLoggerMap.set(orderResultNotifyLogger);
			return orderResultNotifyLogger;
		}else{
			return log;
		}
	}
	 ...
	 * 获取网银结果通知日志记录器
	 */
	public static Log getNetBankResultNotifyLogger() {
		Log log = currentLoggerMap.get();
		if(null == log){
			currentLoggerMap.set(netBankResultNotifyLogger);
			return netBankResultNotifyLogger;
		}else{
			return log;
		}
	}
